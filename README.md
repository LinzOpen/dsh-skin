...
```bash
npx @linzopen/css-guard-cli new my-skin      # 生成骨架
npx @linzopen/css-guard-cli validate skins   # 检查，有 error 退出码 1，可直接当 CI 闸门
npx @linzopen/css-guard-cli pack skins/my-skin   # 打成 zip 分享
```
